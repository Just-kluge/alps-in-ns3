...
#allLoadratioList = ['0.5', '0.55', '0.6', '0.65', '0.7', '0.75', '0.8', '0.85', '0.9', '0.95','1.0']
...
#loadratioListall=[
 ...
 #   '1.0']
loadratioList1=['0.5', '0.55', '0.6', '0.65', '0.7']
#lbsNameList = ['letflow', 'ecmp','laps']
...
#allworkloadNamelist11=['DCTCP_CDF','RPC_CDF','VL2_CDF','FbHdp2015','GoogleRPC2008','AliStorage2019']
        ...
        for patternName, patternLoadRatioShift in onePatternNameMap.items():
            ...
            for workloadName in workloadNamelist:
                ...
                for lbsName in allLbsNameList:
                    ...
                    for loadratio in loadratioList1:

                        workloadFile = vm_workload_path + workloadName + ".txt"

                        fileIdx = (
                            experimentalName + "_" + toponame + "_" + workloadName + "_" +
                        ...
                        '.format(
                            mainFileName, fileIdx, vm_outputFiles_path,
                            vm_inputFiles_path,
                            ...
                            args.testPktNum,
                            workloadFile, patternFile,
                            vm_inputFiles_path + toponame + "/" + args.smtFileName,
                            pitDir, pstDir,
                            enableFlowCongestTest,
                            EnableLLM
                        )
