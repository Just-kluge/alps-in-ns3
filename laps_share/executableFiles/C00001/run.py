...
parser.add_argument("--choose_softmax", default="3", help="决定softmax函数种类")
parser.add_argument("--workloadName", nargs='+',default=["DCTCP_CDF"], help="决定工作负载种类")
parser.add_argument("--loadratio", nargs='+',default=["1.0"], help="决定工作负载率大小")
parser.add_argument("--topoDir", nargs='+',default=["dragonfly"], help="决定网络拓扑种类")
#   dragonfly    railOnly
...
#onePatternNameMap = {'Reduce': 0.333}
